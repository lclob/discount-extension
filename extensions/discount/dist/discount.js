(() => {
  ...
  // extensions/discount/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function App() {
    ...
    (0, import_react8.useEffect)(() => {
      ...
      const targetDiscountCode = "3C3RS5WHE18T";
      const isTargetDiscountApplied = discountCodes.some((code) => code.code === targetDiscountCode);
      console.log("Is target discount applied?", isTargetDiscountApplied);
    ...
    }, [discountCodes, cartLines]);
    function handleAddToCart(variantId) {
      return __async(this, null, function* () {
        const result = yield applyCartChange({
          type: "addCartLine",
